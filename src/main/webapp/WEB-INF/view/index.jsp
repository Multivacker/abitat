            ...
            <div class="content-lg container">
                <div class="row margin-b-40">
                    <div class="col-sm-6">
                        ...
                        <p>Nosotros Somos diferentes, un equipo de amigos con cualidades diferenciales entre sí que supo acoplarse primero por amistad y cariño, y después por desempeño y gusto de dar lo mejor de sí.</br>
                        <p>Nos gusta depuntar el vicio de la innovación y la mejora de procesos ya conocidos, somos creativos, audaces, eficientes, amables y rompedores de dogmas y prejuicios.</p>
                        <p>Una de nuestras mayores aportaciones de valor es la interrelacion de diferentes disciplinas y especialidades dentro de nuestro equipo interdiciplinario con un unico objetivo, el cual es acompañar a que todos y cada uno de nuestros clientes a que alcancen sus metas digitales y de innovacion tecnologica, asesorandoles de manera personalizada, definiendo las estrategias para alcanzarlas y llevandolas a cabo sin importar el reto tecnico y/o comunicativo y marketiniano que implique. s</p>
                    </div>
                </div>
                <!--// end row -->
